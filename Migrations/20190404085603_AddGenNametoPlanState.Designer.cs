...
namespace vega.Migrations
{
    ...
    [Migration("20190404085603_AddGenNametoPlanState")]
    partial class AddGenNametoPlanState
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("vega.Core.Models.Fee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("vegaplannerserver.Core.Models.PlanningAppFees", b =>
                {
                    b.HasOne("vega.Core.Models.Fee", "Fee")
                        .WithMany()
                        .HasForeignKey("FeeId")
                        .OnDelete(DeleteBehavior.Cascade);
